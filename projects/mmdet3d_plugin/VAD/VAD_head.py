...
class VADHead(DETRHead):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        if loss_traj_cls["use_sigmoid"] is True:
            self.traj_num_cls = 1
        else:
            self.traj_num_cls = 2
        ...
        if loss_map_cls["use_sigmoid"] is True:
    ...
    def loss(
        ...
        [map_gt_pts_list for _ in range(num_dec_layers)]
    ...
    def select_and_pad_pred_map(
        ...
        invalid_map_inst = valid_map_inst is False
